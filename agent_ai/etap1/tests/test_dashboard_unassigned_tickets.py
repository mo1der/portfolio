...
def test_dashboard_unassigned_tickets_empty_database():
    response = client.get("/dashboard/unassigned-tickets")
...
def test_dashboard_unassigned_tickets_after_process():
...
def test_dashboard_unassigned_tickets_does_not_return_closed_ticket():
    process_response = client.post(
        "/process",
        json={
    ...
    in_progress_response = client.patch(
        ...
        json={
            ...
            "note": "Przejście do IN_PROGRESS w teście unassigned tickets.",
        },
    )
    ...
    resolved_response = client.patch(
        ...
        json={
            ...
            "changed_by": "test_user",
            "note": "Przejście do RESOLVED w teście unassigned tickets.",
        },
    )
    ...
    closed_response = client.patch(
        ...
        json={
            ...
            "changed_by": "test_user",
            "note": "Zamknięcie ticketa w teście unassigned tickets.",
        },
    )
...
def test_dashboard_unassigned_tickets_limit():
    client.post(
        "/process",
        json={
            "text": "Mam problem z fakturą.",
    ...
    response = client.get("/dashboard/unassigned-tickets?limit=2")
